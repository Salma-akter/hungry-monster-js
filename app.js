...
const displayMeals = (meals) => {
  ...
  meals.forEach((meal) => {
    ...
    mealDiv.innerHTML = `
            <div class="card shadow mb-5 bg-white custom-rounded" data-bs-toggle="modal" data-bs-target="#foodDetails-${
              meal.idMeal
            }">
            ...
            <div class="modal fade" id="foodDetails-${
              meal.idMeal
            }" tabindex="-1" aria-labelledby="foodDetails-${
      meal.idMeal
    }Label" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="foodDetails-${
                              meal.idMeal
                            }Label">${meal.strMeal}</h5>
